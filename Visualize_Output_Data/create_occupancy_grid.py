...
def create_occu_grid(occ_grid, env):
...
if __name__=='__main__':
    ...
    for d in direc:
      for i in range(20):
        cond = direc + str(i) + "/conditions.txt"
        ...
        occ_grid = numpy.ones((30,30,30))

        occ_grid = create_occu_grid(occ_grid, env)

        numpy.savetxt(direc + str(i) + "/occ_grid.txt", occ_grid.ravel(), delimiter=" ", fmt="%s")
